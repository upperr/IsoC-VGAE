...
parser.add_argument('--feature_dim', type = int, default = 32, help = 'Dimension of input features for datasets without node features.')
...
def graph_classification(dataset, embeddings):
    ...
    for epoch in range(args.epochs_task):
        ...
        if val_acc >= best_val:
            ...
            torch.save(classifier.state_dict(), 'best_mlp2.pkl')
            best_val = val_acc
            last_best_epoch = 0
